<p class="text-right">
	<a href="{{ asset('security/berita') }}" class="btn btn-outline-info btn-sm">
...
@endif
<form action="{{ asset('security/berita/proses-tambah') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}
